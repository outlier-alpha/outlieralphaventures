  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-premium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "bg-gradient-primary text-primary-foreground hover:shadow-glow transition-premium shadow-premium border border-primary-glow/20",
        hero: "bg-gradient-secondary text-secondary-foreground hover:bg-secondary-glow transition-premium shadow-glow font-semibold",
        glass: "bg-card/10 backdrop-blur-sm border border-card/20 text-foreground hover:bg-card/20 transition-premium",
      },
      size: {
